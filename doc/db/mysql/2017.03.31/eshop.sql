...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('2', 'admin', 'c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec', '2017-03-31 04:48:44.825791', '1', '2017-03-25 11:29:31.542917', '0');
...
-- ----------------------------
INSERT INTO `django_session` VALUES ('4z58f9u0x471b0bhuoj3vpt1e20dsuhc', 'Mjc0YjZkOTlmMTIyM2JkNDJlNWM0YzQ0YTBlOWZjNjk3NDYwYzY1MDp7Il9zZXNzaW9uX2V4cGlyeSI6ODY0MDAsInVzZXIiOnsiYXBwIjoiY3VzdG9tZXIiLCJpZCI6MX0sImNhcHRjaGFDb2RlIjoid3Y2byJ9', '2017-04-01 09:45:10.916100');
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `order_seller_id_48ec66ac_fk_seller_id` FOREIGN KEY (`seller_id`) REFERENCES `seller` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of seller
-- ----------------------------
INSERT INTO `seller` VALUES ('2', 'seller', 'e14adbb119d492551e40052e7709379550300ea9ccb30a231703e465716f03f628dbd0889c2f1b12dd78e52a8f661051b02530eb1212a642be1313f24897d4bf', '15603005920', 'seller@eshop.com', '', '', '2017-03-31 08:55:45.219333');
